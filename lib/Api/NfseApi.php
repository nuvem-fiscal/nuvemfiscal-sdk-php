...
class NfseApi
{
     ...
     * @return \SplFileObject
     */
    public function baixarXmlDps($id)
    {
        list($response) = $this->baixarXmlDpsWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function baixarXmlDpsWithHttpInfo($id)
    {
        $request = $this->baixarXmlDpsRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function baixarXmlDpsAsync($id)
    {
        return $this->baixarXmlDpsAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function baixarXmlDpsAsyncWithHttpInfo($id)
    {
        $returnType = '\SplFileObject';
        $request = $this->baixarXmlDpsRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function baixarXmlDpsRequest($id)
    {
