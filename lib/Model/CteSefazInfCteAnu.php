 ...
 */
class CteSefazInfCteAnu implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazInfCteAnu';
    ...
    */
     ...
     * Sets ch_cte
     *
     * @param string $ch_cte Chave de acesso do CT-e original a ser anulado e substituído.
     *
     * @return self
     */
     ...
     * Sets d_emi
     *
     * @param \DateTime $d_emi Data de emissão da declaração do tomador não contribuinte do ICMS.
     *
     * @return self
     */
