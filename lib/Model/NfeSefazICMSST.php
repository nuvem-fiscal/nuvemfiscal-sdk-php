    ...
    */
    ...
    public function setVBcstDest($v_bcst_dest)
    {
        if (is_null($v_bcst_dest)) {
            throw new \InvalidArgumentException('non-nullable v_bcst_dest cannot be null');
        }
    ...
    public function setVIcmsstDest($v_icmsst_dest)
    {
        if (is_null($v_icmsst_dest)) {
            throw new \InvalidArgumentException('non-nullable v_icmsst_dest cannot be null');
        }
