...
class Dfe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Data/hora em que o documento foi criado na Nuvem Fiscal. Representado no formato [`ISO 8601`](https://en.wikipedia.org/wiki/ISO_8601).
     *
     * @return self
     */
