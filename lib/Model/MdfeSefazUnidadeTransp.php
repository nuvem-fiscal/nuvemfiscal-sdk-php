...
class MdfeSefazUnidadeTransp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \NuvemFiscal\Model\MdfeSefazLacUnidTransp[]|null $lac_unid_transp Lacres das Unidades de Transporte.
     *
     * @return self
     */
     ...
     * Sets inf_unid_carga
     *
     * @param \NuvemFiscal\Model\MdfeSefazUnidCarga[]|null $inf_unid_carga Informações das Unidades de Carga (Containeres/ULD/Outros).  Dispositivo de carga utilizada (Unit Load Device - ULD) significa todo tipo de contêiner de carga, vagão, contêiner de avião, palete de aeronave com rede ou palete de aeronave com rede sobre um iglu.
     *
     * @return self
     */
