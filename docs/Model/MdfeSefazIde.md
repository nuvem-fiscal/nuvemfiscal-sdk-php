...
**inf_mun_carrega** | [**\NuvemFiscal\Model\MdfeSefazInfMunCarrega[]**](MdfeSefazInfMunCarrega.md) | Informações dos Municípios de Carregamento. |
**inf_percurso** | [**\NuvemFiscal\Model\MdfeSefazInfPercurso[]**](MdfeSefazInfPercurso.md) | Informações do Percurso do MDF-e. | [optional]
