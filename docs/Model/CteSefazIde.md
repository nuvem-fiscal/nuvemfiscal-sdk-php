...
**tp_imp** | **int** | Formato de impressão do DACTE.  Preencher com: 1 - Retrato; 2 - Paisagem. |
...
**tp_amb** | **int** | Tipo do Ambiente.  Preencher com:1 - Produção; 2 - Homologação. | [optional]
